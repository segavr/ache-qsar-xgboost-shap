...
This project is a comprehensive **Quantitative Structure-Activity Relationship (QSAR)** study focused on human Acetylcholinesterase (AChE), a primary therapeutic target for Alzheimer's disease. It demonstrates a complete end-to-end pipeline from data curation to explainable machine learning models and interactive deployment.

**Note on Project Origin:** This repository is the result of a **human-AI collaboration experiment**. The initial codebase, data pipeline, models, and documentation were autonomously generated by the AI agent **Manus** based on a detailed technical prompt. The human owner, **Semen Gavrilov**, then performed a rigorous scientific review, validated the methodology (including scaffold splitting and pIC50 calculations), and refined the final deliverables to ensure professional quality and scientific integrity.
...
- **Models:** Optimized XGBoost models for both regression (pIC50 prediction) and classification (active/inactive).
...
- **License:** MIT
- **Acknowledgments:** Assistance provided by Manus (AI Agent).
...
@misc{gavrilov2026acheqsar,
  ...
  note = {Developed with assistance from Manus AI}
}
```
