...
The majority of the codebase, data processing pipeline, model training, SHAP explainability analysis, and initial documentation were autonomously generated by the AI agent **Manus** based on detailed instructions. 

I (Semen Gavrilov) then reviewed the scientific approach, corrected authorship and licensing, refined the README, validated the methodology (especially scaffold splitting and pIC50 calculation), and made final adjustments to ensure the project meets professional standards.

### Goal of the Experiment
The main purpose of this repository is to explore **how far modern autonomous AI agents can go** in creating a complete, scientifically sound cheminformatics / QSAR project — from raw ChEMBL data to an interactive Streamlit application — with minimal human intervention.
...
- I subsequently reviewed all key scientific decisions, verified the correctness of the QSAR methodology (including proper scaffold splitting to prevent data leakage), improved code comments where needed, updated the documentation, and added the MIT license.

This approach allowed me to complete a full-scale QSAR study significantly faster than doing everything manually, while still maintaining full control over the scientific quality and final result.

The project demonstrates both the impressive productivity gains possible with modern AI tools and the continued importance of human oversight in research-oriented work.
---
